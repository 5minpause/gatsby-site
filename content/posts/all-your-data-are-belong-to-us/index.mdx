...
> The Web Authentication API […] allows web applications to create and use strong, cryptographically attested, and application-scoped credentials to strongly authenticate users.
...
PS: You perhaps recognized the pun in the headline. If not, you can read about it here: [All your base are belong to us](https://en.wikipedia.org/wiki/All_your_base_are_belong_to_us). Excuse my nerdishness 😉

PPS: One more for the German readers: [_Nerdish by nature_](https://youtu.be/KfWyo2mqXnw) 😇
