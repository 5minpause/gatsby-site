---
layout: post
title: "Code Quality through high-quality docs"
...
The first thing should be this article from the resource "Write the docs" (a community of people who care about docs 😊 yes, that exists…):
...
> Should all developers write docs as a matter of course? Is it even worthwhile having specialist writers?
...
This is a [video from a talk given by Beth Aitman](https://www.writethedocs.org/videos/portland/2018/who-writes-the-docs-beth-aitman/) at the Write the docs conf 2018 in Portland. So it's rather recent.
...
This [series](https://medium.com/api-corner/api-documentation/home) on Medium offers lots of insight on writing docs. The parts 1 + 2 from Taylor Barnett are a great start to get you going. It continues with documentation APIs. One important part of your docs.

### Example API docs

These [docs by Stripe](https://stripe.com/docs/api) are something like a (almost?) gold standard for docs. They are really good. Take example 😉
